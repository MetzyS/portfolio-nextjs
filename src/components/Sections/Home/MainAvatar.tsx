  ...
  return (
    <>
      <div className="hidden md:block relative w-max h-max lg:w-max lg:h-max m-auto xl:ml-10 md:col-start-4 md:col-end-7">
        ...
        <div className="relative rounded-full w-80 h-80 lg:w-96 lg:h-96 overflow-hidden drop-shadow-xl shadow-inner-xl-default dark:shadow-inner-xl-dark bg-gray-100 dark:bg-slate-700 col-span-3 col-start-4 ml-6">
